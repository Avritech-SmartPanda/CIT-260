...
public class Triangle extends GeometricObject {
    ...
    public double getArea() {
        double perimeter = (this.getSide1() + this.getSide2() + this.getSide3()) / 2.0;
        double area = perimeter * (perimeter - this.getSide1()) * (perimeter - this.getSide2()) * (perimeter - this.getSide3());
